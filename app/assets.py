...
# Matières premières : la plupart des paires existent chez Twelve Data au
# format XXX/USD, MAIS PAS l'argent — leur catalogue officiel
# (/commodities) ne liste que "XAG/AUD" (argent coté en AUD), pas de
# version USD. On garde donc l'argent exclusivement sur Yahoo (comme les
# indices) pour rester cohérent en USD avec les 3 autres matières
# premières, plutôt que de mélanger les devises de cotation.
#
# Le Brent utilise le ticker "XBR/USD" chez Twelve Data, pas "BRENT/USD"
# (confirmé via /commodities). WTI/USD est bien le bon ticker officiel.
COMMODITIES = [
    {"yahoo": "GC=F", "twelvedata": "XAU/USD", "display": "Or"},
    {"yahoo": "CL=F", "twelvedata": "WTI/USD", "display": "Pétrole WTI"},
    {"yahoo": "BZ=F", "twelvedata": "XBR/USD", "display": "Pétrole Brent"},
]

# Argent : pas de version USD chez Twelve Data sur le catalogue consulté
# (seulement XAG/AUD) -> Yahoo uniquement, toujours, comme les indices.
