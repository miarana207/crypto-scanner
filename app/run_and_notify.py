...
def scan_all(
    ...
    # ------------------------------------------------------------------
    # L'univers crypto est reconstruit à CHAQUE scan à partir de Binance.
    # Les actifs traditionnels restent strictement ceux définis dans assets.py.
    # ------------------------------------------------------------------
    ...
    print(f"Univers crypto Binance : {len(crypto_universe)} marchés sélectionnés")
    print(f"Top Binance : {', '.join(crypto_universe[:10])}")
    ...
    stats = {
        ...
        "crypto_top_symbols": crypto_universe[:10],
